...
<html>
  <head>
	...
	function test(caseId){
		...
		document.frm.action="case/test.do?caseId="+caseId;
		document.frm.submit();
}s
  ...
  <body>
 	<form name="frm" action="<%=path %>/case/caselist.do" method="post">
 	...
 	<div class="tai_right" id="tai_right">
    	...
    	<table width="100%" class="table-ellipsis">
         ...
         <tr class="hang01">
		    ...
		    <td style="text-align:left; line-height:30px; padding:0 7px;" title="${o.testresult}">
		     ${o.url}
		    </td>
		     <td>
		    ${o.type}
		    ...
		    <input id="testbtn"  type="button" class="gaic" value="测试" onclick="test('${o.uuid }')">
		    </td>
		    </tr>
		    </c:forEach>
        </table><br>
